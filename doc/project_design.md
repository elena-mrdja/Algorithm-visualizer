...
* Week 6:
	...
	* Mina - merge Assign class + as many others as possible, do Diagram Scene with Elena, make very clear interfaces (Milena and Katia help). Make sure Github organization is fixed (work with Elena).
